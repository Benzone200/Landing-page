  ...
  return (
    <header className="bg-[#f5f7fa] animate-fade-in px-6 py-10 sm:px-10 lg:px-[150px]">
      <div className="flex flex-col-reverse lg:flex-row items-center justify-between max-w-[1440px] mx-auto">
        {/* Text Section */}
        <div className="w-full lg:w-[50%] pt-6 lg:pt-[50px] md:text-center">
          <h2 className="text-[32px] sm:text-[40px] lg:text-[50px] font-semibold leading-tight text-gray-800">
          ...
          <p className="text-[15px] sm:text-[16px] text-[#717171] max-w-md md:max-w-lg md:mx-auto mb-6">
            Where to grow your business as a photographer: site or social media?
          </p>

          <a
            href="#"
            className="inline-block bg-green-500 hover:bg-green-600 text-white px-6 py-3 rounded-md transition duration-300 md:mx-auto"
          >
            Register
          </a>
        </div>
